            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        model: ListModel {
                            ListElement { version: "v1.7.47"; title: "CRITICAL: settings.json Never Overwritten"; desc: "Fixed: every update wiped user's monitor layout, keybinds, and startup apps"; icon: "󰒃"; clr: "red"; detail: "CRITICAL FIX: install.sh force-overwrote settings.json on every update — wiping users' monitor layout, keybinds, and startup apps. Now only deployed on fresh install. Existing settings.json is never touched. Users with custom monitor setups (multiple displays, different resolutions, custom scaling) no longer lose their configuration on every update." }
